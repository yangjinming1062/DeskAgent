...
import {
  ...
  rollbackRoom,
  setRoomPolicy
} from '@/shared/store/room-backdrop-store'

import { SettingsContent } from './primitives'

function SectionHeading({ subtitle, title }: { subtitle?: string; title: string }): React.JSX.Element {
  return (
...
export function RoomSettings(): React.JSX.Element {
  ...
  return (
    <SettingsContent>
      ...
      <SectionHeading subtitle="最近 5 张" title="回滚历史" />
