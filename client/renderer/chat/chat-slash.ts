import { hydrateChatMessages, markAssistantTerminal, type PendingAttachment, pushStatusPill } from '@/chat/chat-store'
import { ensureChatSession } from '@/chat/session-list-store'
import {
