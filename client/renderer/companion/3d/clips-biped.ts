...
// motion and natural resting arm posture gives the model a live idle even before full keyframe design runs.
...
function _placeholder(
  ...
  return {
    ...
    tracks: {
      ...
      LeftArm: [kf(0, 0.06, 0.04, -1.25), kf(duration / 2, 0.07, 0.05, -1.27), kf(duration, 0.06, 0.04, -1.25)],
      LeftForeArm: [kf(0, 0.18, 0, -0.06), kf(duration / 2, 0.2, 0, -0.08), kf(duration, 0.18, 0, -0.06)],
      RightArm: [kf(0, 0.06, -0.04, 1.25), kf(duration / 2, 0.07, -0.05, 1.27), kf(duration, 0.06, -0.04, 1.25)],
      RightForeArm: [kf(0, 0.18, 0, 0.06), kf(duration / 2, 0.2, 0, 0.08), kf(duration, 0.18, 0, 0.06)]
    }
  }
}
...
export const BIPED_CLIPS: Readonly<Record<string, ClipDef>> = {
  ...
  idle: {
    ...
    tracks: {
      ...
      [_LEFT_ARM]: [kf(0, 0.06, 0.04, -1.24), kf(2, 0.08, 0.05, -1.27), kf(4, 0.06, 0.04, -1.24)],
      [_LEFT_FORE]: [kf(0, 0.18, 0, -0.06), kf(2, 0.22, 0, -0.08), kf(4, 0.18, 0, -0.06)],
      [_RIGHT_ARM]: [kf(0, 0.06, -0.04, 1.24), kf(2, 0.08, -0.05, 1.27), kf(4, 0.06, -0.04, 1.24)],
      [_RIGHT_FORE]: [kf(0, 0.18, 0, 0.06), kf(2, 0.22, 0, 0.08), kf(4, 0.18, 0, 0.06)],
  ...
  listening: {
    ...
    tracks: {
      ...
      [_LEFT_ARM]: [kf(0, 0.06, 0.04, -1.22), kf(1.75, 0.08, 0.06, -1.25), kf(3.5, 0.06, 0.04, -1.22)],
      [_LEFT_FORE]: [kf(0, 0.2, 0, -0.08), kf(1.75, 0.25, 0, -0.1), kf(3.5, 0.2, 0, -0.08)],
      [_RIGHT_ARM]: [kf(0, 0.06, -0.04, 1.22), kf(1.75, 0.08, -0.06, 1.25), kf(3.5, 0.06, -0.04, 1.22)],
      [_RIGHT_FORE]: [kf(0, 0.2, 0, 0.08), kf(1.75, 0.25, 0, 0.1), kf(3.5, 0.2, 0, 0.08)]
    }
  },
  thinking: {
    name: 'thinking',
  ...
  interacting: {
    ...
    tracks: {
      ...
      [_LEFT_ARM]: [kf(0, 0.06, 0.04, -1.24), kf(0.3, 0.15, 0.08, -1.05), kf(1.5, 0.06, 0.04, -1.24)],
      [_LEFT_FORE]: [kf(0, 0.18, 0, -0.06), kf(0.3, 0.35, 0, -0.12), kf(1.5, 0.18, 0, -0.06)],
      [_RIGHT_ARM]: [kf(0, 0.06, -0.04, 1.24), kf(0.3, 0.15, -0.08, 1.05), kf(1.5, 0.06, -0.04, 1.24)],
      [_RIGHT_FORE]: [kf(0, 0.18, 0, 0.06), kf(0.3, 0.35, 0, 0.12), kf(1.5, 0.18, 0, 0.06)]
    }
  },
  emotional_idle: {
    name: 'emotional_idle',
    ...
    tracks: {
      ...
      [_LEFT_FORE]: [kf(0, 0.18, 0, -0.06), kf(1.75, 0.2, 0, -0.08), kf(3.5, 0.18, 0, -0.06)],
      [_RIGHT_ARM]: [kf(0, 0.05, -0.05, 1.22), kf(1.75, 0.08, -0.03, 1.25), kf(3.5, 0.05, -0.05, 1.22)],
      [_RIGHT_FORE]: [kf(0, 0.18, 0, 0.06), kf(1.75, 0.2, 0, 0.08), kf(3.5, 0.18, 0, 0.06)]
    }
  },
  disconnected: {
    name: 'disconnected',
    ...
    tracks: {
      ...
      [_LEFT_FORE]: [kf(0, 0.18, 0, -0.06), kf(2.5, 0.2, 0, -0.08), kf(5, 0.18, 0, -0.06)],
