...
export const QUADRUPED_CLIPS: Readonly<Record<string, ClipDef>> = {
  ...
  quad_walk: _qClip('quad_walk', 1.2, true, 'locomotion', ['欢腾', '机敏', '敏捷'], {
  ...
  quad_run: _qClip('quad_run', 0.6, true, 'locomotion', ['精力充沛', '狂野', '敏捷'], {
  ...
  quad_jump: _qClip('quad_jump', 1.0, false, 'locomotion', ['精力充沛', '活泼', '狂野'], {
  ...
  quad_stalk: _qClip('quad_stalk', 2.0, true, 'locomotion', ['捕猎', '警惕', '机警敏捷'], {
  ...
  quad_pounce: _qClip('quad_pounce', 1.2, false, 'locomotion', ['捕猎', '狂野', '敏捷'], {
    [S0]: [kf(0, 0.1, 0, 0), kf(0.4, -0.25, 0, 0), kf(0.8, 0.3, 0, 0), kf(1.2, 0, 0, 0)],
    [HD]: [kf(0, 0, 0, 0), kf(0.4, 0.2, 0, 0), kf(0.8, -0.1, 0, 0), kf(1.2, 0, 0, 0)]
  }),
  quad_trot: _qClip('quad_trot', 0.9, true, 'locomotion', ['欢腾', '轻快', '开朗'], {
  ...
  // ── Daily & Micro ──
  quad_eat: _qClip('quad_eat', 2.5, true, 'daily', ['贪吃', '憨厚', '温顺'], {
  ...
  quad_drink: _qClip('quad_drink', 2.0, true, 'daily', ['温顺', '乖巧'], {
  ...
  quad_scratch_ear: _qClip('quad_scratch_ear', 2.0, true, 'daily', ['憨厚', '可爱'], {
  ...
  quad_shake_fur: _qClip('quad_shake_fur', 1.5, false, 'daily', ['活泼', '欢腾'], {
  ...
  quad_stretch_front: _qClip('quad_stretch_front', 2.5, false, 'daily', ['惬意', '慵懒'], {
  ...
  quad_stretch_hind: _qClip('quad_stretch_hind', 2.0, false, 'daily', ['惬意', '慵懒'], {
    [LH]: [kf(0, 0, 0, 0), kf(1.0, -0.4, 0, 0), kf(2.0, 0, 0, 0)],
    [RH]: [kf(0, 0, 0, 0), kf(1.0, -0.4, 0, 0), kf(2.0, 0, 0, 0)]
  }),
  quad_yawn: _qClip('quad_yawn', 2.5, false, 'daily', ['懒散', '呆萌'], {
    [HD]: [kf(0, 0, 0, 0), kf(1.0, -0.15, 0, 0), kf(2.5, 0, 0, 0)],
    [JW]: [kf(0, 0, 0, 0), kf(1.0, 0.4, 0, 0), kf(2.5, 0, 0, 0)]
  }),
  quad_pant_happy: _qClip('quad_pant_happy', 1.5, true, 'daily', ['元气', '阳光', '欢腾'], {
  ...
  quad_chew_toy: _qClip('quad_chew_toy', 2.0, true, 'daily', ['贪玩', '拆家', '活泼'], {
  ...
  quad_dig: _qClip('quad_dig', 1.8, true, 'daily', ['拆家', '精力充沛', '贪玩'], {
  ...
  quad_purr: _qClip('quad_purr', 3.0, true, 'interaction', ['撒娇', '温顺可爱', '亲人'], {
  ...
  quad_headbutt: _qClip('quad_headbutt', 1.5, false, 'interaction', ['撒娇', '亲人', '爱抚'], {
    [HD]: [kf(0, 0, 0, 0), kf(0.6, 0.1, 0.25, 0.1), kf(1.5, 0, 0, 0)],
    [S0]: [kf(0, 0, 0, 0), kf(0.6, 0, 0.08, 0), kf(1.5, 0, 0, 0)]
  }),
  quad_roll: _qClip('quad_roll', 2.5, false, 'interaction', ['撒娇', '温顺可爱', '贪玩'], {
    [S0]: [kf(0, 0, 0, 0), kf(1.2, 0, 0, 1.2), kf(2.5, 0, 0, 0)],
    [TL0]: [kf(0, 0, 0, 0), kf(1.2, 0, 0.4, 0), kf(2.5, 0, 0, 0)]
  }),
  quad_belly_up: _qClip('quad_belly_up', 3.5, true, 'intimate', ['顺从', '撒娇', '温顺可爱'], {
  ...
  quad_lick_hand: _qClip('quad_lick_hand', 1.8, false, 'intimate', ['亲人', '爱抚', '忠诚'], {
  ...
  quad_lap_curl: _qClip('quad_lap_curl', 4.0, true, 'intimate', ['温顺', '粘人', '体贴'], {
  ...
  // ── Positive Emotion ──
  quad_happy_wag: _qClip('quad_happy_wag', 1.0, true, 'emotion-positive', ['摇尾', '欢腾', '元气', '开朗'], {
  ...
  quad_play_bow: _qClip('quad_play_bow', 2.0, false, 'emotion-positive', ['贪玩', '欢腾', '精力充沛'], {
  ...
  quad_zoomies: _qClip('quad_zoomies', 1.0, true, 'emotion-positive', ['狂野', '精力充沛', '欢腾'], {
    [S0]: [kf(0, -0.1, 0.2, 0), kf(0.5, 0.1, -0.2, 0), kf(1.0, -0.1, 0.2, 0)],
    [TL0]: [kf(0, 0.3, 0.4, 0), kf(0.5, 0.3, -0.4, 0), kf(1.0, 0.3, 0.4, 0)]
  }),
  quad_curious_tilt: _qClip('quad_curious_tilt', 2.0, false, 'emotion-positive', ['好奇', '呆萌', '灵动'], {
    [HD]: [kf(0, 0, 0, 0), kf(0.6, 0.05, 0.1, 0.35), kf(1.4, 0.05, -0.1, -0.3), kf(2.0, 0, 0, 0)]
  }),
  quad_proud_chest: _qClip('quad_proud_chest', 2.5, true, 'emotion-positive', ['高贵', '威严', '护主'], {
  ...
  quad_excited_hop: _qClip('quad_excited_hop', 1.2, true, 'emotion-positive', ['元气', '开朗', '欢腾'], {
  ...
  quad_sad_whine: _qClip('quad_sad_whine', 3.0, true, 'emotion-negative', ['胆小', '顺从', '惹人怜爱'], {
  ...
  quad_angry_growl: _qClip('quad_angry_growl', 2.0, true, 'emotion-negative', ['凶猛', '护食', '警戒', '暴躁'], {
  ...
  quad_bark_warning: _qClip('quad_bark_warning', 1.0, false, 'emotion-negative', ['警戒', '护主', '领地意识'], {
    [HD]: [kf(0, 0, 0, 0), kf(0.2, -0.2, 0, 0), kf(0.5, 0.1, 0, 0), kf(1.0, 0, 0, 0)],
    [JW]: [kf(0, 0, 0, 0), kf(0.2, 0.35, 0, 0), kf(0.5, 0, 0, 0), kf(1.0, 0, 0, 0)]
  }),
  quad_scared_cower: _qClip('quad_scared_cower', 2.5, true, 'emotion-negative', ['胆小', '敏感', '顺从'], {
  ...
  quad_guard_pose: _qClip('quad_guard_pose', 3.0, true, 'emotion-negative', ['护主', '威严', '警戒', '忠诚'], {
    [S0]: [kf(0, -0.05, 0, 0), kf(1.5, -0.08, 0, 0), kf(3.0, -0.05, 0, 0)],
    [HD]: [kf(0, 0, 0, 0), kf(1.5, 0.05, 0.1, 0), kf(3.0, 0, 0, 0)],
    [TL0]: [kf(0, 0.2, 0, 0), kf(1.5, 0.25, 0, 0), kf(3.0, 0.2, 0, 0)]
  }),
  quad_howl: _qClip('quad_howl', 3.0, false, 'social', ['狂野', '威严', '神秘'], {
  ...
  quad_alert_stand: _qClip('quad_alert_stand', 2.5, true, 'social', ['警惕', '机敏', '敏锐'], {
    [HD]: [kf(0, -0.1, 0.1, 0), kf(1.25, -0.12, -0.1, 0), kf(2.5, -0.1, 0.1, 0)],
    [TL0]: [kf(0, 0.2, 0, 0), kf(1.25, 0.25, 0, 0), kf(2.5, 0.2, 0, 0)]
  }),
  quad_greeting_rub: _qClip('quad_greeting_rub', 2.5, false, 'ritual', ['温柔', '亲人', '忠诚'], {
