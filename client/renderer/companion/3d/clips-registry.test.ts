...
describe('clips-registry', () => {
  ...
  it('summarizes every rig library', () => {
    ...
    expect(counts.biped).toBe(109)
    expect(counts.quadruped).toBeGreaterThan(0)
    expect(counts.avian).toBeGreaterThan(0)
    expect(counts.serpentine).toBeGreaterThan(0)
    expect(counts.aquatic).toBeGreaterThan(0)
    expect(counts.hexapod).toBeGreaterThan(0)
    expect(counts.octopod).toBeGreaterThan(0)
  })
