...
const TRIPO_AVIAN_BONES: AvianBoneSlots = {
  root: 'Hips',
...
export const AVIAN_CLIPS: Readonly<Record<string, ClipDef>> = {
  ...
  avian_sleep: makeClip('avian_sleep', 6, true, 'state', ['温顺', '文静', '安静'], {
    [HD]: [kf(0, 0.3, 0.6, 0), kf(3, 0.35, 0.65, 0), kf(6, 0.3, 0.6, 0)],
    [S0]: [kf(0, -0.05, 0, 0), kf(3, -0.08, 0, 0), kf(6, -0.05, 0, 0)]
  }),
  avian_listen: makeClip('avian_listen', 3, true, 'state', ['机敏', '警觉锐利', '灵巧'], {
    [HD]: [kf(0, 0.05, 0.2, 0.1), kf(1.5, 0.05, -0.2, -0.1), kf(3, 0.05, 0.2, 0.1)]
  }),
  avian_walk: makeClip('avian_walk', 1.0, true, 'locomotion', ['灵巧', '轻盈', '机敏'], {
  ...
  avian_hop: makeClip('avian_hop', 0.6, true, 'locomotion', ['活泼', '轻盈', '元气'], {
  ...
  avian_fly_glide: makeClip('avian_fly_glide', 3.0, true, 'locomotion', ['翱翔', '优雅', '羽翼丰满', '从容不迫'], {
  ...
  avian_fly_flap: makeClip('avian_fly_flap', 0.8, true, 'locomotion', ['翱翔', '展翅', '轻盈', '精力充沛'], {
  ...
  avian_takeoff: makeClip('avian_takeoff', 1.2, false, 'locomotion', ['展翅', '灵巧', '翱翔'], {
  ...
  avian_land: makeClip('avian_land', 1.0, false, 'locomotion', ['从容不迫', '轻盈', '优雅'], {
  ...
  avian_dive: makeClip('avian_dive', 1.5, false, 'locomotion', ['俯冲', '迅捷', '敏锐'], {
  ...
  // ── Daily & Routine ──
  avian_preen: makeClip('avian_preen', 3.0, true, 'daily', ['高贵', '华丽', '优雅', '羽翼丰满'], {
  ...
  avian_peck: makeClip('avian_peck', 0.8, false, 'daily', ['贪吃', '灵巧', '机敏'], {
  ...
  avian_drink: makeClip('avian_drink', 2.0, false, 'daily', ['温顺', '优雅'], {
    [HD]: [kf(0, 0, 0, 0), kf(0.5, 0.5, 0, 0), kf(1.2, -0.4, 0, 0), kf(2.0, 0, 0, 0)],
    [JW]: [kf(0, 0, 0, 0), kf(0.5, 0.2, 0, 0), kf(1.2, 0.1, 0, 0), kf(2.0, 0, 0, 0)]
  }),
  avian_stretch_wing: makeClip('avian_stretch_wing', 2.5, false, 'daily', ['展翅', '优雅', '华丽'], {
  ...
  avian_dust_bath: makeClip('avian_dust_bath', 2.5, true, 'daily', ['可爱', '活泼', '憨厚'], {
  ...
  avian_build_nest: makeClip('avian_build_nest', 3.5, true, 'daily', ['勤劳', '体贴', '顺从'], {
    [HD]: [kf(0, 0.2, 0, 0), kf(0.8, 0.4, 0.2, 0), kf(1.8, 0.35, -0.2, 0), kf(2.8, 0.45, 0, 0), kf(3.5, 0.2, 0, 0)]
  }),

  // ── Interaction & Ritual ──
  avian_sing: makeClip('avian_sing', 3.5, true, 'interaction', ['啼鸣', '鸣啭', '华丽', '轻快活泼'], {
    [HD]: [
      kf(0, -0.1, 0, 0),
      kf(0.8, -0.3, 0.1, 0),
      kf(1.8, -0.35, -0.1, 0),
  ...
  avian_nuzzle: makeClip('avian_nuzzle', 2.0, false, 'intimate', ['撒娇', '亲人', '温柔', '温婉'], {
    [HD]: [kf(0, 0, 0, 0), kf(0.8, 0.1, 0.3, 0.15), kf(2.0, 0, 0, 0)],
    [LW0]: [kf(0, 0, 0, 0), kf(0.8, 0, 0, 0.2), kf(2.0, 0, 0, 0)]
  }),
  avian_mating_display: makeClip('avian_mating_display', 3.0, true, 'ritual', ['求偶', '华丽', '高贵', '展翅'], {
  ...
  avian_bow: makeClip('avian_bow', 2.0, false, 'ritual', ['高贵', '体面', '优雅'], {
  ...
  avian_shoulder_perch: makeClip('avian_shoulder_perch', 4.0, true, 'intimate', ['亲人', '忠诚', '粘人'], {
    [S0]: [kf(0, 0.02, 0, 0), kf(2.0, 0.04, 0, 0), kf(4.0, 0.02, 0, 0)],
    [HD]: [kf(0, 0, 0.1, 0), kf(2.0, 0.05, -0.1, 0), kf(4.0, 0, 0.1, 0)]
  }),

  // ── Positive Emotion ──
  avian_happy_chirp: makeClip('avian_happy_chirp', 1.5, true, 'emotion-positive', ['欢腾', '开朗', '元气', '灵巧'], {
  ...
  avian_wing_flutter: makeClip('avian_wing_flutter', 1.0, true, 'emotion-positive', ['欢腾', '活泼', '轻盈'], {
  ...
  avian_head_bob: makeClip('avian_head_bob', 1.2, true, 'emotion-positive', ['俏皮', '呆萌', '搞怪'], {
    [HD]: [kf(0, 0.1, 0, 0), kf(0.3, -0.15, 0, 0), kf(0.6, 0.1, 0, 0), kf(0.9, -0.15, 0, 0), kf(1.2, 0.1, 0, 0)]
  }),
  avian_proud_crest: makeClip('avian_proud_crest', 2.5, true, 'emotion-positive', ['高傲', '高贵', '威严'], {
  ...
  avian_scared_flap: makeClip('avian_scared_flap', 1.2, true, 'emotion-negative', ['胆小', '警惕', '聒噪'], {
  ...
  avian_threat_hiss: makeClip('avian_threat_hiss', 2.0, true, 'emotion-negative', ['凶猛', '警戒', '聒噪', '暴躁'], {
  ...
  avian_squawk_angry: makeClip('avian_squawk_angry', 1.0, false, 'emotion-negative', ['暴躁', '聒噪', '叛逆'], {
    [HD]: [kf(0, 0, 0, 0), kf(0.3, -0.2, 0, 0), kf(0.7, 0.1, 0, 0), kf(1.0, 0, 0, 0)],
    [JW]: [kf(0, 0, 0, 0), kf(0.3, 0.45, 0, 0), kf(0.7, 0, 0, 0), kf(1.0, 0, 0, 0)]
  }),
  avian_sulking: makeClip('avian_sulking', 3.5, true, 'emotion-negative', ['傲娇', '孤傲', '冷漠'], {
