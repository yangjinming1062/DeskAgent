...
import { BTN_SUBTLE, HINT_TEXT, SECTION_TITLE } from '@/shared/panel'
  ...
  return (
    <>
      <div className="space-y-6">
        <div>
          <h2 className="text-sm font-semibold text-strong">角色与记忆</h2>
          <p className="mt-1 text-[11px] leading-relaxed text-faint">人设怎么改、记得什么，都在这里。</p>
        </div>
        <PersonaSection />
