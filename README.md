...
* **生活空间与工作台双入口**：双击桌面精灵唤出上次停留的界面。生活空间提供沉浸的伙伴卧室，16:9 场景将角色直接绘于房间画卷中，辅以微动呼吸感，窗口内不放置独立 2D/3D 模型、桌面精灵隐身让位；工作台专攻生产力，采用三栏会话与调试布局且无室内背景干扰，桌面透明精灵在窗口外贴边栖息陪伴。两扇门扉严格互斥，生活与工作界限分明。
