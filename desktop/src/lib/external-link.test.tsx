...
const desktopWindow = window as unknown as { zastDesktop?: Window['zastDesktop'] }
const initialZastDesktop = desktopWindow.zastDesktop

function installDesktopBridge(partial: Partial<Window['zastDesktop']> = {}) {
  desktopWindow.zastDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['zastDesktop']
}
...
afterEach(() => {
  ...
  if (initialZastDesktop) {
    desktopWindow.zastDesktop = initialZastDesktop
  } else {
    delete desktopWindow.zastDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['zastDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['zastDesktop']['openExternal'] })
