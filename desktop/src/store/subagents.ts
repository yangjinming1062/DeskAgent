...
export interface SubagentProgress {
  id: string
  /** Backend Conversation.id — absent on legacy delegate_task fallback rows. */
  sessionId?: string
...
interface SubagentNode extends SubagentProgress {
...
function toProgress(payload: SubagentPayload, prev: SubagentProgress | undefined, eventType = ''): SubagentProgress {
  ...
  return {
    ...
    sessionId: str(payload.session_id) || prev?.sessionId,
