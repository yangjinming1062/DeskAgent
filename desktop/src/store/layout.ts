...
const SIDEBAR_PINNED_STORAGE_KEY = 'zast.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'zast.desktop.agentsGroupedByWorkspace'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'zast.desktop.sessionOrder'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'zast.desktop.workspaceOrder'
const PANES_FLIPPED_STORAGE_KEY = 'zast.desktop.panesFlipped'
...
export const SESSION_SEARCH_FOCUS_EVENT = 'zast:focus-session-search'
