...
import { FileText, FolderOpen, ImageIcon, Link, MonitorPlay, Terminal } from '@/lib/icons'
...
function AttachmentPill({ attachment, onRemove }: { attachment: ComposerAttachment; onRemove?: (id: string) => void }) {
  ...
  const canPreview = attachment.kind !== 'folder' && attachment.kind !== 'terminal' && attachment.kind !== 'video'
