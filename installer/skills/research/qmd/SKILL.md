...
DeskAgent Agent via the native MCP client. This is the preferred
...
Add to `${DESKAGENT_HOME:-~/.deskagent}/config.yaml`:
...
Then configure DeskAgent Agent to connect via HTTP:
