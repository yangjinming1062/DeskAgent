...
from core import commands_catalog
from core import discard_user
from core import dispatch_user_event
from core import exec_slash_command
from core import JsonRpcDispatcher
from core import JsonRpcEmitter
from core import JsonRpcError
from core import load_user_settings
from core import MANAGER
from core import new_runtime_session
from core import path_attach_ref
from core import REGISTRY
from core import REQUEST_ID_HEADER
from core import resolve_future
from core import resolve_user_llm_config
from core import run_chat_turn
...
async def chat_websocket(websocket: WebSocket, token: str):
    ...
    # 必须在 authenticate 之前 set, 不然 auth_helpers 里的 'WS token decode failed'
    ...
    # JSON-RPC 2.0 dispatcher — see core/jsonrpc_dispatcher.py. All inbound
    ...
    # Runtime sessions — see core/runtime_sessions.py. Per-WS map keyed
    ...
    async def commands_catalog_handler(_params: dict) -> dict:
        # Catalog is derived from core.slash_commands._HANDLERS so it never
